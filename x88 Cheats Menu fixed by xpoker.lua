...
gui.Text(x88_info, "Fixed by xpoker on July 26th, 2020.")
...
if gui.GetValue("lbot.master") then
	...
	draw.TextShadow(x,y+120,"pSilent:")
...
--Functions--		
	...
	local btValue = gui.GetValue("lbot.extra.backtrack")
	local btEnabled = gui.GetValue("lbot.posadj.backtrack")
	
    if btEnabled == false or btValue == 0 then
		draw.Color(clr_func_off:GetValue())
		draw.TextShadow(x+150,y+45,"OFF")
		
		elseif btValue <= 100 then
		draw.Color(25,193,33,255)
		draw.TextShadow(x+150,y+45,btValue.." ms")
		
		elseif btValue <= 150 then
		draw.Color(255,255,0,255)
		draw.TextShadow(x+150,y+45,btValue.." ms")
		
		elseif btValue <= 200 then
		draw.Color(255,165,0,255)
		draw.TextShadow(x+150,y+45,btValue.." ms")
		
		elseif btValue <= 400 then
		draw.Color(255,0,0,255)
		draw.TextShadow(x+150,y+45,btValue.." ms")
	end
...
local offyspecial = 30
if ToggleMisc:GetValue() then
    offyspecial = offyspecial + 90
end

    draw.TextShadow(x+240,y+offyspecial+15,"BOX ESP:")
	draw.TextShadow(x+240,y+offyspecial+30,"Box Precision:")
	draw.TextShadow(x+240,y+offyspecial+45,"Chams:")
	draw.TextShadow(x+240,y+offyspecial+60,"Chams XQZ:")
	draw.TextShadow(x+240,y+offyspecial+75,"BTChams:")
	draw.TextShadow(x+240,y+offyspecial+90,"BTChams XQZ:")
	draw.TextShadow(x+240,y+offyspecial+105,"Glow:")
	draw.TextShadow(x+240,y+offyspecial+120,"Player Indicators:")
	draw.TextShadow(x+240,y+offyspecial+135,"Bullet Tracers:")
...
if gui.GetValue("esp.chams.enemy.visible") == 0 then
    ...
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+45,  "Pearlescent" )
    elseif gui.GetValue("esp.chams.enemy.visible") == 6 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+45,  "Bubble" )
	elseif gui.GetValue("esp.chams.enemy.visible") == 7 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+45,  "Textured" )
	elseif gui.GetValue("esp.chams.enemy.visible") == 8 then
    draw.Color(clr_func_on:GetValue())
...
if gui.GetValue("esp.chams.enemy.occluded") == 0 then
	...
	elseif gui.GetValue("esp.chams.enemy.occluded") == 5 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+60,  "Pearlescent" )
	elseif gui.GetValue("esp.chams.enemy.occluded") == 6 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+60,  "Bubble" )
end
if gui.GetValue("esp.chams.backtrack.visible") == 0 then
    ...
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+75,  "Pearlescent" )
    elseif gui.GetValue("esp.chams.backtrack.visible") == 6 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+75,  "Bubble" )
	elseif gui.GetValue("esp.chams.backtrack.visible") == 7 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+75,  "Textured" )
	elseif gui.GetValue("esp.chams.backtrack.visible") == 8 then
    draw.Color(clr_func_on:GetValue())
...
if gui.GetValue("esp.chams.backtrack.occluded") == 0 then
    ...
    elseif gui.GetValue("esp.chams.backtrack.occluded") == 5 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+90,  "Pearlescent" )
    elseif gui.GetValue("esp.chams.backtrack.occluded") == 6 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+90,  "Bubble" )	
end
if gui.GetValue("esp.chams.enemy.glow") == 0 then
	...
	draw.Color(clr_func_on:GetValue())
	draw.TextShadow(x+355,y+offyspecial+105,"Color")
	elseif gui.GetValue("esp.chams.enemy.glow") == 2 then
	draw.Color(0,255,0,255)
	draw.TextShadow(x+355,y+offyspecial+105,"Health")
end
if gui.GetValue("esp.local.outofview") == 0 then
    draw.Color(clr_func_off:GetValue())
    draw.TextShadow(x+355,y+offyspecial+120, "OFF")
    elseif gui.GetValue("esp.local.outofview") == 1 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+120, "Arrow")
	elseif gui.GetValue("esp.local.outofview") == 2 then
    draw.Color(clr_func_on:GetValue())
    draw.TextShadow(x+355,y+offyspecial+120, "Arrow+Info")
end
...
if ToggleMisc:GetValue() then
    ...
    draw.TextShadow(x+240,y+15,"Auto-Strafe:")
	draw.TextShadow(x+240,y+30,"Bunny-Hop:")
	draw.TextShadow(x+240,y+45,"FakeLag:")
	draw.TextShadow(x+240,y+60,"Fake PING:")
	draw.TextShadow(x+240,y+75,"Hitsound:")
	draw.TextShadow(x+240,y+90,"Hitmarker:")
	draw.TextShadow(x+240,y+105,"Clantag:")
	draw.TextShadow(x+240,y+120,"Ping:")
...
if ToggleAdvanced:GetValue() then
	if gui.GetValue("misc.strafe.enable") then
		...
		if gui.GetValue("misc.strafe.mode") == 0 then
		draw.Color(255,0,0,255)
	...
	if gui.GetValue("misc.autojump") == 0 then
    draw.Color(clr_func_off:GetValue())
    draw.TextShadow(x+355,y+30, 'OFF')
	
    elseif gui.GetValue("misc.autojump") == 1 then
    draw.Color(255,255,0,255)
    draw.TextShadow(x+355,y+30, 'Perfect')
	
    elseif gui.GetValue("misc.autojump") == 2 then
    draw.Color(25,193,33,255)
...
if gui.GetValue("misc.fakelag.condition.peek") then
        draw.Color(clr_func_on:GetValue())
        draw.TextShadow(x+460,y+45, "+ ON PEEK")
end
end    
    end
...
if ToggleAdvanced:GetValue() then
local flValue = gui.GetValue("misc.fakelatency.amount")	
...
if gui.GetValue("misc.fakelatency.enable") then
        ...
        elseif flValue <= 100 then
        draw.Color( 25, 193, 33, 255 )
        draw.TextShadow(x+390,y+60, "  "..flValue)
		
		elseif flValue <= 350 then
        draw.Color( 255, 255, 0, 255 )
        draw.TextShadow(x+390,y+60, "  "..flValue)
		
		elseif flValue <= 700 then
        draw.Color( 255, 165, 0, 255 )
        draw.TextShadow(x+390,y+60, "  "..flValue)
		
		elseif flValue <= 1000 then
        draw.Color( 255, 0, 0, 255 )
        draw.TextShadow(x+390,y+60, "  "..flValue)
...
draw.TextShadow(x,y+120,"AA Fake Yaw:")
draw.TextShadow(x,y+135,"AA Real Yaw:")
draw.TextShadow(x,y+150,"KnifeBot:")
--Functions--
        ...
        if gui.GetValue("rbot.antiaim.pitchstyle") == 0 then
        draw.Color(clr_func_off:GetValue())
        draw.TextShadow(x+150,y+105, "OFF")
        elseif gui.GetValue("rbot.antiaim.pitchstyle") == 1 then
        draw.Color(clr_func_on:GetValue())
        draw.TextShadow(x+150,y+105, "89`")
        elseif gui.GetValue("rbot.antiaim.pitchstyle") == 2 then
        draw.Color(255,0,0,255)
        draw.TextShadow(x+150,y+105, "180`")
		elseif gui.GetValue("rbot.antiaim.pitchstyle") == 3 then
        draw.Color(255,255,0,255)
        draw.TextShadow(x+150,y+105, "Zero")
end
		if gui.GetValue("rbot.antiaim.yawfakestyle") == 0 then
		draw.Color(clr_func_off:GetValue())
		draw.TextShadow(x+150,y+120,"OFF")
		
		elseif gui.GetValue("rbot.antiaim.yawfakestyle") == 1 then
		draw.Color(clr_func_on:GetValue())
		draw.TextShadow(x+150,y+120,"Default")
		
		elseif gui.GetValue("rbot.antiaim.yawfakestyle") == 2 then
		draw.Color(clr_func_on:GetValue())
		draw.TextShadow(x+150,y+120,"Opposite")
		
		elseif gui.GetValue("rbot.antiaim.yawfakestyle") == 3 then
		draw.Color(clr_func_on:GetValue())
		draw.TextShadow(x+150,y+120,"Jitter")
end
		if gui.GetValue("rbot.antiaim.yawstyle") == 0 then
		draw.Color(clr_func_off:GetValue())
		draw.TextShadow(x+150,y+135,"OFF")
		
		elseif gui.GetValue("rbot.antiaim.yawstyle") == 1 then
		draw.Color(clr_func_on:GetValue())
		draw.TextShadow(x+150,y+135,"Backward")
		
		elseif gui.GetValue("rbot.antiaim.yawstyle") == 2 then
		draw.Color(clr_func_on:GetValue())
		draw.TextShadow(x+150,y+135,"Spinbot")
end
		if string.match(tostring(gui.GetValue("rbot.aim.extra.knife")), "Off") then
        draw.Color(clr_func_off:GetValue())
        draw.TextShadow(x+150,y+150,"OFF")
        elseif string.match(tostring(gui.GetValue("rbot.aim.extra.knife")), "Default Knifebot") then
        draw.Color(clr_func_on:GetValue())
        draw.TextShadow(x+150,y+150,"Default")
        elseif string.match(tostring(gui.GetValue("rbot.aim.extra.knife")), "Only Backstab") then
        draw.Color(clr_func_on:GetValue())
        draw.TextShadow(x+150,y+150,"TF2 Spy")
        elseif string.match(tostring(gui.GetValue("rbot.aim.extra.knife")), "Quick Stab") then
        draw.Color(clr_func_on:GetValue())
        draw.TextShadow(x+150,y+150,"Quick")
end
end
--End of Ragebot Menu--
